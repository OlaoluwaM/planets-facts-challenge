...
module.exports = {
  ...
  theme: {
    ...
    fontSize: {
      ...
      navBase: ['0.938rem', { letterSpacing: '1.35px', lineHeight: '100%' }],
      base: ['1rem', { lineHeight: '1.5rem' }],
      lg: ['1.125rem', { lineHeight: '1.75rem' }],
      xl: ['1.25rem', { lineHeight: '100%', letterSpacing: '-0.75px' }],
      '2xl': ['1.5rem', { lineHeight: '2rem' }],
      '3xl': ['1.875rem', { lineHeight: '2.25rem' }],
      '4xl': ['2.25rem', { lineHeight: '2.5rem' }],
      custom4xl: ['2.5rem', { lineHeight: '52px', letterSpacing: '-1.5px' }],
      '5xl': ['3rem', { lineHeight: '1px' }],
      '6xl': ['3.75rem', { lineHeight: '1px' }],
      '7xl': ['4.5rem', { lineHeight: '1px' }],
      '8xl': ['6rem', { lineHeight: '1px' }],
      h1: ['6rem', { lineHeight: '103px' }],
      '9xl': ['8rem', { lineHeight: '1px' }],
    },
    fontWeight: {
      thin: '100',
      extralight: '200',
